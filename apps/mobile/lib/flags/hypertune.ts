...
export const queryCode = `query FullQuery{root{isOnMaintenance isBetaEnabled exampleFlag}}`;

export const query: sdk.Query<sdk.ObjectValueWithVariables> = {"variableDefinitions":{},"fragmentDefinitions":{},"fieldQuery":{"Query":{"type":"InlineFragment","objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"type":"InlineFragment","objectTypeName":"Root","selection":{"isOnMaintenance":{"fieldArguments":{},"fieldQuery":null},"isBetaEnabled":{"fieldArguments":{},"fieldQuery":null},"exampleFlag":{"fieldArguments":{},"fieldQuery":null}}}}}}}}};

export const vercelFlagDefinitions = {"isOnMaintenance":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/8104/main/draft/logic?selected_field_path=root%3EisOnMaintenance"},"isBetaEnabled":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/8104/main/draft/logic?selected_field_path=root%3EisBetaEnabled"},"exampleFlag":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/8104/main/draft/logic?selected_field_path=root%3EexampleFlag"}};
...
const rootFallback = {isOnMaintenance:false,isBetaEnabled:false,exampleFlag:false};
...
export class RootNode extends sdk.Node {
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/8104/main/draft/logic?selected_field_path=root%3EisOnMaintenance})
   */
  isOnMaintenance({ args = {}, fallback }: { args?: EmptyObject; fallback: boolean; }): boolean {
    const props0 = this.getFieldNodeProps("isOnMaintenance", { fieldArguments: args });
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/8104/main/draft/logic?selected_field_path=root%3EisBetaEnabled})
   */
  isBetaEnabled({ args = {}, fallback }: { args?: EmptyObject; fallback: boolean; }): boolean {
    const props0 = this.getFieldNodeProps("isBetaEnabled", { fieldArguments: args });
    const expression0 = props0.expression;
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/8104/main/draft/logic?selected_field_path=root%3EexampleFlag})
   */
...
const sourceFallback = {root:{isOnMaintenance:false,isBetaEnabled:false,exampleFlag:false}};
