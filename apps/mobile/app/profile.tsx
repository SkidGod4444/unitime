...
export default function Profile() {
  ...
  const showExperimental = hypertune.isBetaEnabled({ fallback: false });
      ...
      >
        ...
        <View className="mx-5 mt-5 rounded-3xl overflow-hidden border border-gray-100 shadow-sm bg-white">
          ...
          <View className="items-center -mt-12 pb-5 px-5">
            ...
            {/* Name */}
            <Text className="text-xl font-bold font-lora text-zinc-900 mt-3">
        ...
        <View className="mt-8 px-5 gap-6">
          ...
          <View>
            ...
            <TouchableOpacity
              ...
              className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden p-4 flex-row items-center justify-between"
            >
              <View className="flex-row items-center gap-4">
                <View className="h-10 w-10 bg-blue-50 rounded-full items-center justify-center">
                  <Ionicons
            ...
            <TouchableOpacity
              ...
              className="mt-3 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden p-4 flex-row items-center justify-between"
            >
              <View className="flex-row items-center gap-4">
          ...
          {/* Experimental Features Flag Block */}
          {showExperimental ? (
            <View>
              <Text className="text-sm font-bold text-amber-500 uppercase tracking-widest mb-3 ml-1">
                Experimental
              </Text>
