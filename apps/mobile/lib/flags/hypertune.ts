        ...
        root: {
          ...
          fieldQuery: {
            Root: {
              ...
              objectTypeName: "Root",
              selection: {
                isOnMaintenance: { fieldArguments: {}, fieldQuery: null },
                isBetaEnabled: { fieldArguments: {}, fieldQuery: null },
...
export const vercelFlagDefinitions = {
  isOnMaintenance: {
    ...
    origin:
      "https://app.hypertune.com/projects/8104/main/draft/logic?selected_field_path=root%3EisOnMaintenance",
  },
  isBetaEnabled: {
    options: [
      { label: "Off", value: false },
    ...
    origin:
      "https://app.hypertune.com/projects/8104/main/draft/logic?selected_field_path=root%3EisBetaEnabled",
  },
  exampleFlag: {
    options: [
      { label: "Off", value: false },
    ...
    origin:
      "https://app.hypertune.com/projects/8104/main/draft/logic?selected_field_path=root%3EexampleFlag",
  },
};
...
export class RootNode extends sdk.Node {
  ...
  isOnMaintenance({
    ...
    const props0 = this.getFieldNodeProps("isOnMaintenance", {
      fieldArguments: args,
    });
  ...
  isBetaEnabled({
    ...
    const props0 = this.getFieldNodeProps("isBetaEnabled", {
      fieldArguments: args,
    });
    const expression0 = props0.expression;
...
const sourceFallback = {
  root: { isOnMaintenance: false, isBetaEnabled: false, exampleFlag: false },
};
